...
void si1147_init()
{
	...
	si1147_write_reg(SI1147_UCOEF0_REG, 0x29);
	si1147_write_reg(SI1147_UCOEF0_REG, 0x89);
	si1147_write_reg(SI1147_UCOEF0_REG, 0x02);
	si1147_write_reg(SI1147_UCOEF0_REG, 0x00);
